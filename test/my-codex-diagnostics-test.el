    ...
    (my-codex-test--with-mock-flycheck diagnostics
      (cl-letf (((symbol-function 'my-codex-project-root)
        ...
        (let ((prompt (my-codex--diagnostic-batch-prompt diagnostics)))
          ...
          (should (string-match-p "duplicate_count: 0" prompt))
          (should (string-match-p "included_unique_count: 2" prompt))
          (should (string-match-p "omitted_unique_count: 1" prompt))
    ...
    (my-codex-test--with-mock-flycheck diagnostics
      (cl-letf (((symbol-function 'my-codex-project-root)
        ...
        (let ((prompt (my-codex--diagnostic-batch-prompt diagnostics)))
          ...
          (should (string-match-p "duplicate_count: 1" prompt))
          (should (string-match-p "included_unique_count: 2" prompt))
          (should (string-match-p "omitted_unique_count: 0" prompt))
          (should (string-match-p "truncated: false" prompt))
          (should (= 1
                     (let ((start 0)
                           (count 0))
    ...
    (my-codex-test--with-mock-flycheck diagnostics
      (cl-letf (((symbol-function 'my-codex-project-root)
        ...
        (let ((prompt (my-codex--diagnostic-batch-prompt diagnostics)))
          ...
          (should (string-match-p "unique_diagnostic_count: 2" prompt))
          (should (string-match-p "duplicate_count: 1" prompt))
          (should (string-match-p "included_unique_count: 1" prompt))
          (should (string-match-p "omitted_unique_count: 1" prompt))
          (should (string-match-p "truncated: true" prompt)))))))
    ...
    (my-codex-test--with-mock-flycheck diagnostics
      (cl-letf (((symbol-function 'my-codex-project-root)
        ...
        (let ((prompt (my-codex--diagnostic-batch-prompt diagnostics)))
          (should (string-match-p "diagnostic_count: 3" prompt))
          (should (string-match-p "included_unique_count: 1" prompt))
          (should (string-match-p "omitted_unique_count: 2" prompt))

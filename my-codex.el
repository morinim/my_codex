...
(eval-and-compile
  ...
  (defconst my-codex-command-catalogue
    '((:command my-codex-read-only :key "o" :label "Read-only" :group "Session" :menu "Show/start read-only" :help "Show the configured agent in read-only mode")
      ...
      (:command my-codex-resume :key "r" :label "Resume" :group "Session" :menu "Resume session" :help "Resume a previous agent session")
      ...
      (:command my-codex-git-review-transient :key "g" :label "Review diff..." :group "Git" :menu "Review Git diff" :help "Open Git diff review commands")
      (:command my-codex-show-git-diff :key "v" :label "View diff" :group "Git" :menu "View Git diff" :help "Show the current Git diff in a diff-mode buffer")
      (:command my-codex-show-git-staged-diff :key "V" :label "View staged diff" :group "Git" :menu "View staged Git diff" :help "Show the staged Git diff in a diff-mode buffer")
      (:command my-codex-ediff-current-file-against-head :key "d" :label "Ediff current file" :group "Git" :menu "Ediff current file against HEAD" :available my-codex--current-or-left-file-available-p :help "Review the current file's uncommitted changes against HEAD")
      (:command my-codex-ediff-changed-file-against-head :key "D" :label "Ediff changed file" :group "Git" :menu "Ediff changed file against HEAD" :help "Choose a tracked changed file and review it against HEAD")
      ...
      (:command my-codex-send-git-diff :key "a" :label "All changes" :group "Review diff" :prefix my-codex-git-review-transient :path "g" :menu "Review all Git changes" :help "Ask the active agent to review the current Git diff")
      (:command my-codex-send-git-staged-diff :key "s" :label "Staged changes" :group "Review diff" :prefix my-codex-git-review-transient :path "g" :menu "Review staged Git changes" :help "Ask the active agent to review the staged Git diff")
      (:command my-codex-review-current-file-diff :key "f" :label "Current file" :group "Review diff" :prefix my-codex-git-review-transient :path "g" :menu "Review current-file Git diff" :available my-codex--current-or-left-file-available-p :help "Ask the active agent to review only the current file's Git diff")
